        ...
        <div className="mx-auto max-w-[1200px] px-5">
          <div className="rounded-2xl p-6 md:p-7 flex flex-col md:flex-row items-center justify-between gap-4 border border-white/20 bg-white/10 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,.25)]">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              ...
              <a className="px-4 py-2 rounded-full font-bold border border-white/70 transition-all duration-200 hover:-translate-y-[1px] active:translate-y-[1px] hover:bg-white/10 hover:ring-2 ring-white/30" href="https://www.wearewineconnect.com">Wine Connect</a>
            </div>
          </div>
        </div>
      </section>
...
function QuickForm() {
  ...
  return (
    <>
      <form onSubmit={onSubmit} className="rounded-2xl p-5 grid gap-4 border border-white/10 bg-white/[0.04]" noValidate>
        {/* Honeypot + timestamp */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <Field label="Azienda">
            ...
            <input name="azienda" required placeholder="Cantina / Azienda" className="bg-transparent outline-none w-full placeholder:text-white/40" />
          </Field>
          <Field label="Nome referente">
            <Building2 className="h-4 w-4 text-white/60" />
            <input name="referente" required placeholder="Nome e cognome" className="bg-transparent outline-none w-full placeholder:text-white/40" />
          </Field>
          <Field label="Email">
          ...
          <Field label="Telefono">
            ...
            <input name="telefono" inputMode="tel" placeholder="+39 ..." className="bg-transparent outline-none w-full placeholder:text-white/40" />
          </Field>
          <Field label="Produzione annua (bottiglie)">
            ...
            <input name="produzione_annua" type="number" min="0" step="100" placeholder="es. 50.000" className="bg-transparent outline-none w-full placeholder:text-white/40" />
          </Field>
          <div className="grid gap-1">
            ...
            <div className="flex items-center gap-2 rounded-xl px-3 py-3 bg-black/30 border border-white/10">
              <select name="spedisce_gia" className="bg-transparent outline-none w-full">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          disabled={submitting}
          className="mt-1 h-12 rounded-xl font-semibold text-base text-[#0f1720] w-full transition-all duration-200 hover:-translate-y-[1px] active:translate-y-[1px] hover:shadow-orange-500/20 hover:ring-2 ring-orange-300/50 disabled:opacity-60"
      ...
      {toast && (
        <div className="mt-3 text-center">
          <span className="inline-block px-3 py-2 rounded-lg border border-white/15 bg-white/10 text-sm">
            {toast}
          </span>
        </div>
      )}
