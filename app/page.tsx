...
export default function Home() {
  ...
  return (
    <main
      ...
      style={{
        // background più scuro, più vicino alla pagina Paylink
        background:
          'radial-gradient(140% 160% at 50% -20%, #132436 0%, #05070f 55%, #000 120%)',
      }}
    >
      {/* HEADER RIUSABILE */}
          ...
          {[
            ...
            >
              <div className="flex items-center gap-3">
                <div className="shrink-0 grid place-items-center rounded-xl w-9 h-9 bg-white/5 border border-white/10">
                  {x.icon}
                </div>
                <div>
      ...
      <section id="servizi" className="py-12">
        ...
        <div className="mx-auto max-w-[1200px] px-5 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
          {[
            ...
            <Card key={title} title={title} text={text as string} />
          ))}
        </div>
      ...
      <section id="chi" className="py-12">
        ...
        <div className="mx-auto max-w-[1200px] px-5 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
          {[
            ...
            [
              'Distributori',
              'Flussi costanti e palette ricorrenti in Europa e USA.',
            ],
            [
              'Importatori',
              'Assistenza documentale, consolidamenti e tempi rapidi.',
            ],
            [
              'E-commerce',
              'Campionature e B2C con soluzioni integrate di spedizione.',
            ],
          ].map(([title, text]) => (
            <Card key={title} title={title as string} text={text as string} />
          ))}
        </div>
      </section>
