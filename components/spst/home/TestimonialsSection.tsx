...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    flag: "🇺🇸",
    rating: 5,
    text: "Ottima web app, facile da usare. Ho spedito campionature per una fiera in Asia e tutto è arrivato perfetto. Il supporto è stato eccezionale durante tutto il processo.",
  },
  {
    name: "Luca Bianchi",
    country: "Italia",
